describe("About Objects", function () {
    ...
    var megalomaniac = {
      ...
      battleCry: function (noOfBrains) {
        return "They are " + this.henchman + " and the" +
          Array(noOfBrains + 1).join(" " + this.mastermind); // Array is created, then .join() returns a string
      }
    };
  ...
  it("should confirm that when a function is attached to an object, 'this' refers to the object", function () {
    var currentDate = new Date(); // Wed Sep 09 2015 01:23:36 GMT-0600 (MDT)
    ...
    var megalomaniac = {
      ...
      calculateAge: function () {
        return currentYear - this.birthYear; // 2015-1970
      }
    };
